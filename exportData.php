...
include_once("./language/exportData_string.php");
...
<head>
  ...
  <title>Admin Control Panel - Export Data</title>
  ...
  <div class="container-fluid">
	...
	?>	
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		...
		<form action="./toCSV.php" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
			<?php echo $type[$lang]; ?>:
			<select class="form-control" id="dataType" name="dataType">
				<option value="1"><?php echo $type1[$lang]; ?></option>
				<option value="2" selected><?php echo $type2[$lang]; ?></option>
				<option value="3"><?php echo $type3[$lang]; ?></option>
			</select>
			<br><br>
			<?php echo $from[$lang]; ?>: <input type="month" id="startMonth" name="startMonth" class="form-control" required> 
			<br><br>
			<?php echo $to[$lang]; ?>: <input type="month" id="endMonth" name="endMonth" class="form-control" required> 
			<br><br>
			<div id="hints" class="text-danger" style="display: none;"><?php echo $invalidDate[$lang]; ?></div>
			<br><br>
			
			<button class="btn btn-success"><i class='fas fa-file-csv'></i>&nbsp;<?php echo $export[$lang]; ?></button>
			<!--
			...
			<button class="btn btn-success"><i class='far fa-file-excel'></i>&nbsp;Export</button>
			
			
			<button class="btn btn-success"><i class='fas fa-file-download'></i>&nbsp;Export</button>
			<button class="btn btn-success"><i class='fas fa-cloud-download-alt'></i>&nbsp;Export</button>
