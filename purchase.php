...
$addQty = htmlspecialchars($_POST['addQty'], ENT_QUOTES);
...
$sql2 = "INSERT INTO `item_stock_record` (`stock_record_id`, `item_id`, `amendment_qty`, `amendment_status`, `amendment_remarks`, `amend_date`, `amend_time`, `staff_id`) VALUES ($next_stock_record_id, '$item_ID', $addQty, '$amendment_status', '$remarks', '$amend_date', '$amend_time', '$staff')";
