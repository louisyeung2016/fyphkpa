...
$reduceDrinksQty = htmlspecialchars($_POST['reduceDrinksQty'], ENT_QUOTES);
...
$sql2 = "INSERT INTO `drinks_stock_record`(`record_id`, `drinks_id`, `unit_cost`, `stock_qty`, `stock_action`, `stock_remarks`, `stock_date`, `stock_time`, `staff_id`) VALUES ($next_record_id, '$drinks_ID', $unitPrice, $reduceDrinksQty, '$amendment_status', '$remarks', '$amend_date', '$amend_time', '$staff')";
...
$new_qty = $rc3['stock_qty'] - $reduceDrinksQty;
