...
include_once("./language/modifyDrinksCategory_string.php");
...
<html lang="en">
  <head>
    ...
    <title>Admin Control Panel - Modify Drinks Category</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		...
		<div id="Add" class="tabcontent">
		  ...
		  <br>
		  <form action="addNewDrinks.php" method="post" enctype="multipart/form-data" onsubmit="return varifyDrinksInfo()">
		  	  <?php echo $name[$lang]; ?>:  &emsp;
			  <input type="text" id="drinksName" name="drinksName" placeholder="drinks name" required >
			  </br></br>
			  <?php echo $barCode[$lang]; ?>:  &emsp;
			  <input type="text" id="drinksBarCode" name="drinksBarCode" placeholder="drinks BarCode" pattern="^[0-9]*$" title="number only" required >
			  </br></br>
			  <?php echo $qty[$lang]; ?>:  &emsp;
			  <input type="number" id="stockQty" name="stockQty" min="0" max="9999" value="0" title="please use purchase function to add Quantity" readonly required >
			  </br></br>
			  <?php echo $outOfStockLevel[$lang]; ?>:  &emsp;
			  <input type="number" id="outOfStockQty" name="outOfStockQty" min="0" max="9999" value="0" required >
			  </br>
			  <?php echo $outOfStockLevel_hints[$lang]; ?>
			  </br></br>
			  <?php echo $price[$lang]; ?>:  &emsp;
			  <input type="number" id="drinksPrice" name="drinksPrice" placeholder="Price HKD$" min="0" step="0.01" required >
			  </br></br>
			  ...
			  <input type="submit" name="submitToAdd" class="btn btn-primary" value="<?php echo $btn_conf[$lang]; ?>" > 
			  </br></br>
		  </form>
		</div>
		...
		<div id="Remove" class="tabcontent">
		  ...
		  <br>
		  <div id="txtHint"><b><?php echo $drinkInfo[$lang]; ?></b></div>
		...
		<div id="Edit" class="tabcontent">
		  ...
		  <br>
		  <div id="txtHint2"><b><?php echo $drinkInfo[$lang]; ?></b></div>
...
<script>
	...
	function showItem(str) {
	  if (str == "") {
		...
		xmlhttp.open("GET","getdrinks.php?d1="+str,true);
		xmlhttp.send();
	  }
	}
	...
	function showItem2(str) {
	  if (str == "") {
		...
		xmlhttp.open("GET","getdrinks.php?d2="+str,true);
		xmlhttp.send();
	  }
	}
	...
	function varifyDrinksInfo(){ //itemName
		let original_drinksName = $("#drinksName").val();
		let clean_drinksName = DOMPurify.sanitize($("#drinksName").val());
		if(original_drinksName.trim()==""){
			alert("invalid drinks name");
			return false;
		}else if(clean_drinksName != original_drinksName){
			alert("invalid drinks name");
			return false;
		}else{
			return true;
	...
	function varifyEditDrinksInfo(){ //itemName
		let original_drinksName = $("#drinksName_edit").val();
		let clean_drinksName = DOMPurify.sanitize($("#drinksName_edit").val());
		if(original_drinksName.trim()==""){
			alert("invalid drinks name");
			return false;
		}else if(clean_drinksName != original_drinksName){
