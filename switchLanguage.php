...
if(!isset($_SESSION["language_index"])){
	$_SESSION["language_index"] = 0;
}

if($_SESSION["language_index"] == 0){
	$_SESSION["language_index"] = 1;
}elseif($_SESSION["language_index"] == 1){
	$_SESSION["language_index"] = 0;
}
...
$preference_index_language = intval($preference_index[0]);
if($preference_index_language == 0){
	$preference_index_language = 1;
}else{
	$preference_index_language = 0;
}

$updated_preference_index = strval($preference_index_language).$preference_index[1].$preference_index[2];
