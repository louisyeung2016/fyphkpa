...
<div class="container-fluid">
 ...
 <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
			...
			<details open>
				<summary><span class="h6"><?php echo $stfMan[$lang]; ?></span></summary>
				<div class="row">

				<?php echo $dashboard_box_staffManagement_str; ?>
...
<script type="module">
	...
	$(document).ready(function(){
		...
		$.ajax({url: "./controller/controller_dashboard_data.php", success: function(result){
			...
			$("#box13_number1").hide().html(obj.box13_number1).css("color", "red").fadeTo(4000, 1);
			setTimeout(function() { 
				$("#box13_number1").animate({color: "<?php echo $dynamic_text_color;?>"}, 3000);
			}, 4000);

			$("#box13_number2").hide().html(obj.box13_number2).css("color", "red").fadeTo(4000, 1);
			setTimeout(function() { 
				$("#box13_number2").animate({color: "<?php echo $dynamic_text_color;?>"}, 3000);
			}, 4000);

			$("#box13_number3").hide().html(obj.box13_number3).css("color", "red").fadeTo(4000, 1);
			setTimeout(function() { 
				$("#box13_number3").animate({color: "<?php echo $dynamic_text_color;?>"}, 3000);
			}, 4000);
		}});
	});
</script>